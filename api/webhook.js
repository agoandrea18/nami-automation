...
// - SHOPIFY_API_SECRET=yyyy
// - SHOPIFY_WEBHOOK_SECRET=zzzz
// - TEST_MODE=true/false (opzionale)
...
// =========================
// Read Fulfillment Orders via REST + retry
// =========================
...
async function handleFulfillmentCreate(payload) {
  ...
  for (const o of giacenze) {
    ...
    for (const fo of fosRest) {
      ...
      console.log("   - Creo fulfillment per FO id:", fo.id);
